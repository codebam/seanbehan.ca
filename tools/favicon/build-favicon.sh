...
#
# The two colours are the site's own: #bc5215 is --accent-warm and #fffcf0 is
# --bg, the paper the SB is knocked out of. Re-ink them here and in
# public/favicon.svg together, or the tab and the manifest start disagreeing
# with the page.
#
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
  <rect width="64" height="64" rx="$5" fill="#bc5215"/>
  <text x="32" y="$6" text-anchor="middle" font-family="Newsreader" font-weight="$3"
    font-size="$2" fill="#fffcf0" letter-spacing="$4">SB</text>
</svg></body></html>
EOF
}
