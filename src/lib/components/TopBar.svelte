...
<Navbar class="bg-background dark:bg-background-dark">
  ...
  <NavUl>
    ...
    <NavLi class="text-primary dark:text-dark-primary hover:text-tertiary hover:dark:text-dark-tertiary" href="/resume">Resume</NavLi>
    <NavLi class="text-primary dark:text-dark-primary hover:text-tertiary hover:dark:text-dark-tertiary" href="https://p.seanbehan.ca">Pastebin</NavLi>
    <NavLi class="text-primary dark:text-dark-primary hover:text-tertiary hover:dark:text-dark-tertiary" href="https://term.seanbehan.ca">Terminal</NavLi>
  </NavUl>
  <NavHamburger />
</Navbar>
