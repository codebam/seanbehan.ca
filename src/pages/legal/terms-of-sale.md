...
The product is a downloadable source-code kit, documentation, example application, and related materials. The advertised base price is $59 CAD for a one-time purchase. Stripe Checkout displays the final currency, applicable taxes, and total before you pay. The Checkout total controls if it differs from a converted or estimated amount displayed elsewhere.

You must provide accurate Checkout and contact information and be old enough to enter a binding contract where you live.
...
Purchase includes releases published during the first year after purchase. The purchaser keeps access to the originally purchased release and eligible updates, subject to the Product License and payment remaining valid.

The purchase does not include custom implementation, deployment, incident response, consulting, or guaranteed response times unless separately agreed in writing.

## Refunds

Refund eligibility and procedure are described in the [Refund Policy](/legal/refund-policy). An approved refund ends the associated license and download entitlement, except where applicable law requires a different result.

## Product responsibility

You are responsible for reviewing and testing the kit, adapting configuration and sample code, protecting secrets, maintaining backups, monitoring deployments, and confirming that your use complies with applicable law and third-party terms. The kit is a technical starting point, not legal, tax, security, or compliance advice.
...
The version in effect when you purchase governs that purchase. Updated terms may apply to future purchases but will not retroactively reduce rights already granted unless applicable law requires the change.

## Governing law

These terms are governed by the laws of Ontario and the federal laws of Canada applicable there, without regard to conflict-of-law rules. The courts of Ontario have jurisdiction, except that mandatory consumer protections or forum rights where you live continue to apply.
