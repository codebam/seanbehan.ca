...
description: How Sean Behan collects, uses, shares, and protects information from site visitors and product purchasers.
---
...
If you email Sean Behan, the message, your email address, and related correspondence are used to answer your request and maintain an appropriate support record.
...
Where applicable law requires a legal basis, processing is based on performing the purchase contract, your consent, compliance with legal obligations, and Sean Behan's legitimate interests in operating and securing the service.
...
Send requests to [sean@seanbehan.ca](mailto:sean@seanbehan.ca). Enough information may be requested to verify that the request concerns you. For payment details held by Stripe, use the privacy controls or contact information in Stripe's privacy policy.

## Security

Sean Behan uses access controls, signed Stripe webhooks, private object storage, payment-state checks, and restricted caching around commerce routes. No internet service can guarantee absolute security.
