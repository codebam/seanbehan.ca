...
const staticPaths = () => [
	...
	'/about',
	'/contact',
	// /links and the whole commercial surface have one canonical home,
	// seanbehan.ca, so the codebam sitemap must not advertise second copies.
	...(site.id === 'seanbehan'
		? [
				'/links',
				'/services',
				'/products/cloudflare-workers-production-kit',
				'/legal/privacy',
				'/legal/terms-of-sale',
				'/legal/refund-policy',
				'/legal/product-license'
			]
		: []),
