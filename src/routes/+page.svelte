...
>
	...
	<!-- Ambient orbs -->
	<div class="pointer-events-none absolute -top-20 -left-20 h-72 w-72 rounded-full bg-[var(--accent-blue)]/10 blur-3xl"></div>
	<div class="pointer-events-none absolute -right-20 -bottom-32 h-80 w-80 rounded-full bg-[var(--accent-magenta)]/10 blur-3xl"></div>
	...
	<div class="relative z-10 flex flex-col items-center gap-8 md:flex-row md:items-center">
		...
		<div class="shrink-0">
			<div class="relative mx-auto h-32 w-32 md:h-40 md:w-40">
				<div class="absolute inset-0 animate-pulse rounded-full bg-gradient-to-br from-[var(--accent-blue)] via-[var(--accent-blue-light)] to-[var(--accent-magenta)] opacity-40 blur-xl"></div>
				<div class="absolute inset-0 rounded-full bg-gradient-to-br from-[var(--accent-blue)] via-[var(--accent-blue-light)] to-[var(--accent-magenta)] p-[3px]">
					<img
						src="/profile.webp"
						alt="Sean Behan"
		...
		<div class="flex-1 text-center md:text-left">
			...
			<h1 class="mb-3 text-4xl leading-tight font-extrabold tracking-tight text-[var(--text-primary)] md:text-5xl">
				Sean Behan
			</h1>
			...
			<p id="bio" class="max-w-2xl text-base leading-relaxed text-[var(--text-secondary)] md:text-lg">
			...
			<div class="mt-6 flex flex-wrap justify-center gap-3 md:justify-start">
				<a
					href={resolve('/posts')}
					class="inline-flex items-center gap-2 rounded-xl bg-[var(--accent-blue)] px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:bg-[var(--accent-blue-hover)] hover:shadow-xl hover:shadow-[var(--accent-blue)]/30 active:scale-[0.97]"
				>
				...
				<a
					...
					target="_blank"
					rel="noopener noreferrer"
					class="inline-flex items-center gap-2 rounded-xl border border-[var(--text-tertiary)]/40 bg-[var(--surface-card-alt)]/60 px-6 py-3 text-sm font-semibold text-[var(--text-primary)] backdrop-blur-sm transition-all duration-200 hover:border-[var(--accent-blue)]/40 hover:bg-[var(--surface-hover)]/60 hover:shadow-lg active:scale-[0.97]"
				>
				...
				<a
					...
					class="inline-flex items-center gap-2 rounded-xl border border-[var(--text-tertiary)]/40 bg-[var(--surface-card-alt)]/60 px-6 py-3 text-sm font-semibold text-[var(--text-primary)] backdrop-blur-sm transition-all duration-200 hover:border-[var(--accent-green)]/40 hover:bg-[var(--surface-hover)]/60 hover:shadow-lg active:scale-[0.97]"
				>
					<svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<div class="grid gap-6 md:grid-cols-3">
	<div class="group card relative h-full overflow-hidden p-6" style="--panel-accent: var(--accent-blue);">
		<div class="spotlight" style="background: color-mix(in srgb, var(--panel-accent) 5%, transparent); filter: blur(40px); transition: background 0.5s ease, filter 0.5s ease;"></div>
		<div class="relative z-10">
			<div class="mb-3 flex h-10 w-10 items-center justify-center rounded-xl" style="background: color-mix(in srgb, var(--panel-accent) 10%, transparent);">
				<svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="var(--panel-accent)" stroke-width="1.5">
	...
	<div class="group card relative h-full overflow-hidden p-6" style="--panel-accent: var(--accent-green);">
		<div class="spotlight" style="background: color-mix(in srgb, var(--panel-accent) 5%, transparent); filter: blur(40px); transition: background 0.5s ease, filter 0.5s ease;"></div>
		<div class="relative z-10">
			<div class="mb-3 flex h-10 w-10 items-center justify-center rounded-xl" style="background: color-mix(in srgb, var(--panel-accent) 10%, transparent);">
				<svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="var(--panel-accent)" stroke-width="1.5">
	...
	<div class="group card relative h-full overflow-hidden p-6" style="--panel-accent: var(--accent-magenta);">
		<div class="spotlight" style="background: color-mix(in srgb, var(--panel-accent) 5%, transparent); filter: blur(40px); transition: background 0.5s ease, filter 0.5s ease;"></div>
		<div class="relative z-10">
			<div class="mb-3 flex h-10 w-10 items-center justify-center rounded-xl" style="background: color-mix(in srgb, var(--panel-accent) 10%, transparent);">
				<svg width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="var(--panel-accent)" stroke-width="1.5">
...
<section class="mt-16 mb-8">
	<div class="mb-6 flex items-center justify-between">
		...
		<a
			...
			target="_blank"
			rel="noopener noreferrer"
			class="inline-flex items-center gap-1 text-sm font-medium text-[var(--accent-blue)] transition-colors hover:text-[var(--accent-blue-light)]"
		>
			All repositories
			<svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
		...
		{#each data.projects as project (project.repo)}
			<article class="group card relative flex h-full flex-col overflow-hidden p-6">
				...
				<div class="relative z-10 flex h-full flex-col">
						...
						{#if project.stars > 0}
							...
							>
								<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
									<path d="M11.48 3.5a.56.56 0 0 1 1.04 0l2.13 4.9 5.32.51c.5.05.7.68.32 1.02l-4.01 3.54 1.17 5.23c.11.49-.42.88-.85.62L12 16.6l-4.6 2.72c-.43.26-.96-.13-.85-.62l1.17-5.23-4.01-3.54c-.38-.34-.18-.97.32-1.02l5.32-.51 2.13-4.9Z" />
								</svg>
								{project.stars}
							</span>
						{/if}
					...
					<p class="mb-4 text-sm leading-relaxed text-[var(--text-secondary)]">{project.description}</p>

					<div class="mb-4 flex flex-wrap gap-2">
						<span class="rounded-full bg-[var(--accent-blue)]/10 px-2.5 py-0.5 text-xs text-[var(--accent-blue-light)]">
							{project.language}
						</span>
					...
					<div class="mt-auto flex flex-wrap gap-3">
						<a
							...
							target="_blank"
							rel="noopener noreferrer"
							class="inline-flex items-center gap-2 rounded-lg border border-[var(--text-tertiary)]/40 bg-[var(--surface-card-alt)]/60 px-4 py-2 text-xs font-semibold text-[var(--text-primary)] transition-all duration-200 hover:border-[var(--accent-blue)]/40 hover:bg-[var(--surface-hover)]/60"
						>
						...
						{#if project.homepage}
							...
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								class="inline-flex items-center gap-2 rounded-lg bg-[var(--accent-blue)] px-4 py-2 text-xs font-semibold text-white transition-all duration-200 hover:bg-[var(--accent-blue-hover)]"
							>
...
<section class="mt-16 mb-8">
	<div class="mb-6 flex items-center justify-between">
		<div>
			...
			<p class="mt-1 text-sm text-[var(--text-tertiary)]">Thoughts on tech, Linux, and building things</p>
		</div>
		<a
			href={resolve('/posts')}
			class="inline-flex items-center gap-1 text-sm font-medium text-[var(--accent-blue)] transition-colors hover:text-[var(--accent-blue-light)]"
